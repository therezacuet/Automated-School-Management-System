				...
				<div style="width: 951px;margin: 108px auto;;">
					<table>
						...
						<tr>
							...
							<td>
								<select type="text" name="field4" class="ins_input_xsm" style="width: 200px;" required>
										<option>Choose a Group</option>
										<?php getGroup();?>
								</select>
							</td>
							<td>
								<input  type="text" name="field5" class="ins_input_xsm" style="width: 200px;" placeholder="Year" required>
							</td>
						</tr>
					</table>
...
<?php
	if (isset($_POST['submit'])) {
		...
		echo "<script>window.open('tabulation_sheet.php?tab_exam=$field2&tab_class=$field3&tab_group=$field4&tab_year=$field5','_self')</script>";
	}
?>