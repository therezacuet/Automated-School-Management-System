...
<div class="container">
    ...
    left: 209px;">
			...
			<div class="type Source-Sans-Pro">TEACHER</div>
			...
			<div class="pos absolute uppercase Source-Sans-Pro"><?php echo $fld21;?></div>
			<div class="id absolute  Source-Sans-Pro"><?php echo $fld2;?></div>
			<div class="blood absolute  Source-Sans-Pro">Blood of Group: <?php echo $fld13;?></div>
			<div class="add absolute  Source-Sans-Pro">Address:  <?php echo $fld15;?></div>
