		...
		<div class="admin_area">
			...
			<form method="post" enctype="multipart/form-data">
				<div class="ins_table_sm">
					<table>
						<tr>
							<td class="ins_td_sm" style="width: 121px;">Add Section:</td>
							<td>
								<input  type="text" name="admission_date" class="ins_input_sm" placeholder="Section name" required>
							</td>
						</tr>
					</table>
			...
			<table class="cls_xtab" style="border: 1px solid #A5A5A5;text-align: center;">
				<tr style="border: 1px solid #A5A5A5;text-align: center;background: #EBEBEB;">
					...
					<th style="border: 1px solid #A5A5A5;text-align: center;">Section Name</th>
				...
				<?php
					...
					while ($ccsql_get=mysqli_fetch_array($ccsql_run)) {
						...
						<tr style="border: 1px solid #A5A5A5;text-align: center;">
							...
							<td style="border: 1px solid #A5A5A5;text-align: center;"><a href='section.php?sec_delete=<?php echo $class_id;?>'><img class="delete_icon" src="image/delete.png"></a></td>
						</tr>
...
<?php
	if (isset($_POST['head_info_submit'])) {
		...
		$csql="INSERT INTO `section` (`sec_id`, `sec_name`) VALUES (NULL, '$class_name')";
...
<?php
	if(isset($_GET['sec_delete'])){
		$cls_id=$_GET['sec_delete'];

		$not_sql="DELETE FROM `section` WHERE `section`.`sec_id` = '$cls_id'";
